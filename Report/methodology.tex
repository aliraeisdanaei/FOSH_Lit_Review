...
\hline
Q1. Does the study describe clear criteria for the selection of the hardware and software components used in the AT? & (1: strongly disagree to 3: strongly agree) \\
\hline
Q2. Does the study show a method and experiments that allow validating the AT? & (1: strongly disagree to 3: strongly agree) \\
\hline
Q3. Does the study indicate the scope and limitations of the AT developed? & (1: strongly disagree to 3: strongly agree) \\
\hline
Q4. Is the developed AT accessible, replicable, and reusable? & (1: strongly disagree to 3: strongly agree) \\
\hline
Q5. Has the study been cited by other authors? & (1: Yes, 3: No) \\
\hline
\end{tabular}
\end{table}
